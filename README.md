...
bcm4390b1<sup>5,8,9</sup> | 27_10_1121_57_26 (g9f20a98) | Google Pixel 9 | Rooted with [Magisk](https://github.com/topjohnwu/Magisk)           |     |     |     |  X  |  X  |    
...
**Note:** We currently support Kernel Version 4.4 (deprecated), 4.9, 4.14, 4.19, 5.4, 5.10, 5.15, 6.1, 6.2, 6.6, 6.18 and 7.2. The driver directory is selected automatically from `uname -r`, so a kernel whose `major.minor` has no matching `patches/driver/brcmfmac_<ver>.y-nexmon` directory builds the firmware but silently skips the driver. Raspbian contains firmware version 7.45.154 for the bcm43455c0. We also support the newer firmware release 7.45.189 from Cypress. Raspberry Pi OS contains firmware version 7.45.206. Please, try which works best for you.
