...
There is a library that won't compile with the rest, you will find it from the error message, and fix it by issuing a 'make' in the appropriate folder somewhere in app/app/
