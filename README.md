...
# Important changes
* We started to collect usage statistics. In the file [STATISTICS.md](https://github.com/seemoo-lab/nexmon/STATISTICS.md), you can find information on which data we collect and how you can opt-out of the statistics collection
