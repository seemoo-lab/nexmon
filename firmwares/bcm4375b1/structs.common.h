...
struct wlc_hw_info {
    ...
    char PAD;                   // 0x1bc
    char PAD;                   // 0x1bd
    char hdrconv_mode;          // 0x1be verified bcm4375b1
    char PAD;                   // 0x1bf
    char PAD;                   // 0x1c0
    char corerev_minor;         // 0x1c1 verified bcm4375b1
    char PAD;                   // 0x1c2
    char PAD;                   // 0x1c3
    int PAD;                    // 0x1c4
    int PAD;                    // 0x1c8
...
typedef struct sk_buff {
	int field0;                        /* 0x00 */
	int field4;                        /* 0x04 */
	void *data;                        /* 0x08 verified bcm4375 */
	short len;                         /* 0x0C verified bcm4375 */
    short fieldE;                       // 0x0E
    int flags;                          // 0x10 verified bcm4375
    char field14;                       // 0x14
    char field15;                       // 0x15
    char field16;                       // 0x16
    char ifidx;                         // 0x17
    ...
    int PAD;                            // 0x38
    int PAD;                            // 0x3c
    unsigned int hdr_conv_at_0x400;     // 0x40 verified bcm4375b1
    int PAD;                            // 0x44
    int PAD;                            // 0x48
    int PAD;                            // 0x4c
    int PAD;                            // 0x50
    unsigned short frag_used_len;       // 0x54 verified bcm4375b1
    int PAD;                            // 0x58
    int PAD;                            // 0x5c
...
struct tunables {
    char PAD[0xF4];             /* 0x000 */
    unsigned int copycount;     /* 0x0F4 */
    char PAD[0x50];             /* 0x0F8 */
    unsigned int hwrxoffext;    /* 0x148 */
};
...
struct phy_info {
    ...
    struct phy_info_acphy *pi_acphy;  /* 0x00c */
    uint32 PAD;                       /* 0x010 */
    uint32 PAD;                       /* 0x014 */
    uint32 PAD;                       /* 0x018 */
    uint32 PAD;                       /* 0x01c */
...
struct wlcband {
    ...
    void *hwrs_scb;                     /* 0x014 verified bcm4375b1 */
    char gmode;                         /* 0x015 */
    char PAD;                           /* 0x016 */
    char PAD;                           /* 0x017 */
    int PAD;                            /* 0x018 */
    ...
    int PAD;                            // 0x048
    int PAD;                            // 0x04c
    unsigned int hw_rateset;            // 0x050 veriried bcm4375b1
    int PAD;                            // 0x054
    int PAD;                            // 0x058
    int PAD;                            // 0x05c
    int PAD;                            // 0x060
...
struct wlc_monitor_info {
    struct wlc_info *wlc;               // 0x00
    void *mon_cal_timer;                // 0x04
    void *buf_32bytes;                  // 0x08
    unsigned int promisc_bits;          // 0x0C
    int PAD;                            // 0x10
    unsigned char timer_active;         // 0x14
    char PAD;                           // 0x15
    char PAD;                           // 0x16
    char PAD;                           // 0x17
    unsigned short chanspec;            // 0x18
    short PAD;                          // 0x1A
    void *buf_12bytes;                  // 0x1C
};

struct wlc_info {
    struct wlc_pub *pub;                /* 0x000 verified bcm4375b1 */
    struct osl_info *osh;               /* 0x004 verified bcm4375b1 */
    struct wl_info *wl;                 /* 0x008 verified bcm4375b1 */
    volatile struct d11regs *regs;      /* 0x00C */
    int PAD;                            /* 0x010 */
    int PAD;                            /* 0x014 */
    struct wlc_hw_info *hw;             /* 0x018 verified bcm4375b1 */
    void *core;                         /* 0x01C */
    bool PAD;                           /* 0x020 */
    bool clk;                           /* 0x021 verified bcm4375b1 */
    bool PAD;                           /* 0x022 */
    bool PAD;                           /* 0x023 */
    int PAD;                            /* 0x024 */
    int PAD;                            /* 0x028 */
    struct phy_info *pi;                /* 0x02C verified bcm4375b1 */
    struct wlcband *band;               /* 0x030 verified bcm4375b1 */
    struct wlcband *bandstate[2];       /* 0x034 verified bcm4375b1 */
    int PAD;                            /* 0x03C */
    int PAD;                            /* 0x040 */
    int PAD;                            /* 0x044 */
    int PAD;                            /* 0x048 */
    ...
    int PAD;                            /* 0X368 */
    int PAD;                            /* 0X36C */
    void *active_queue;                 /* 0X370 verified bcm4375 */
    int PAD;                            /* 0X374 */
    int PAD;                            /* 0X378 */
    int PAD;                            /* 0X37C */
    int PAD;                            /* 0X380 */
    ...
    int PAD;                            /* 0X388 */
    int PAD;                            /* 0X38C */
    unsigned short hwrxoff;             /* 0X390 verified bcm4375 */
    unsigned short PAD;                 /* 0X392 */
    int PAD;                            /* 0X394 */
    int PAD;                            /* 0X398 */
    int PAD;                            /* 0X39C */
    int PAD;                            /* 0X3A0 */
    ...
    int PAD;                            /* 0X484 */
    int PAD;                            /* 0X488 */
    struct wlc_monitor_info *mon_info;  /* 0X48C verified bcm4375b1*/
    int PAD;                            /* 0X490 */
    int PAD;                            /* 0X494 */
    int PAD;                            /* 0X498 */
    int PAD;                            /* 0X49C */
...
struct wlc_pub {
    ...
    int PAD;                            /* 0x018 */
    int PAD;                            /* 0x01C */
    struct tunables *tunables;          /* 0x020 verified bcm4375b1*/
    char up_maybe;                      /* 0x024 */
    char field_25;                      /* 0x025 */
    char field_26;                      /* 0x026 */
    char field_27;                      /* 0x027 */
    ...
    int PAD;                            /* 0x03C */
    int PAD;                            /* 0x040 */
    char _pktc;                         /* 0x044 verified bcm4375b1 */
    char PAD;                           /* 0x045 */
    char field_46;                      /* 0x046 */
    char PAD;                           /* 0x047 */
    int PAD;                            /* 0x048 */
    ...
    int PAD;                            /* 0x174 */
    char PAD;                           /* 0x178 */
    char _mon;                          /* 0x179 verified bcm4375b1 */
    char PAD;                           /* 0x17A */
    char PAD;                           /* 0x17B */
    int PAD;                            /* 0x17C */
    int PAD;                            /* 0x180 */
