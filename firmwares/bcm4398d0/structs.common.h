...
struct sk_buff {
    ...
    uint32 pkttag[8];                 /* 0x020 */
} __attribute__((packed));
typedef struct sk_buff sk_buff;
typedef struct sk_buff lbuf;

typedef void (*hnd_timer_mainfn_t)(void *timer);
...
struct hndrte_timer {
    ...
    void *data;                       /* 0x030 */
    hnd_timer_mainfn_t mainfn;        /* 0x034 */
    hnd_timer_auxfn_t auxfn;          /* 0x038 */
    uint32 PAD;                       /* 0x03c */
    uint32 PAD;                       /* 0x040 */
    void *dpc;                        /* 0x044 */
    uint32 PAD;                       /* 0x048 */
...
struct wlc_hw_tunables {
    uint16 PAD;                       /* 0x000 */
    uint16 PAD;                       /* 0x002 */
    uint16 rxbufsz;                   /* 0x004 */
    uint16 field_0x006;               /* 0x006 */
    uint16 PAD;                       /* 0x008 */
    uint16 PAD;                       /* 0x00a */
    uint16 PAD;                       /* 0x00c */
    uint16 PAD;                       /* 0x00e */
    uint16 copycount;                 /* 0x010 */
    uint16 PAD;                       /* 0x012 */
    uint16 field_0x014;               /* 0x014 */
    uint16 PAD;                       /* 0x016 */
    uint16 PAD;                       /* 0x018 */
    uint16 rxbound;                   /* 0x01a */
    uint16 PAD;                       /* 0x01c */
    uint16 PAD;                       /* 0x01e */
    uint16 PAD;                       /* 0x020 */
    uint16 PAD;                       /* 0x022 */
...
struct wlc_hw_info {
    ...
    uint32 PAD;                       /* 0x280 */
    uint32 PAD;                       /* 0x284 */
    struct wlc_hw_tunables *tunables; /* 0x288 */
    uint32 PAD;                       /* 0x28c */
    uint32 PAD;                       /* 0x290 */
    uint32 PAD;                       /* 0x294 */
    uint32 PAD;                       /* 0x298 */
