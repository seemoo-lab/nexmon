...

{
  ...
  if ((*(char *)(iVar3 + 6) == '\0') && (-1 < (int)((uint)*(byte *)(p + 0x1f) << 0x1d))) {
    ...
    if (iVar1 == 1) {
      if ((*(ushort *)txh[7] >> 4 & 10) != 0) goto LAB_0000f6dc;
    }
    else {
      if (((iVar1 == 2) && ((int)(uVar4 << 0x19) < 0)) &&
         ((**(char **)(iVar3 + 0x104) != '\x01' || (-1 < (int)(uVar4 << 0x1c))))) goto LAB_0000f6dc;
    }
    local_28 = fifo;
...
LAB_0000f6dc:
  ...
  local_28 = (**(code **)(DAT_0000f75c + 0x28))
                       (*(undefined4 *)(*(int *)(wlc + 0x14) + fifo * 4),p,(uint)commit,
                        *(code **)(DAT_0000f75c + 0x28),local_28);
