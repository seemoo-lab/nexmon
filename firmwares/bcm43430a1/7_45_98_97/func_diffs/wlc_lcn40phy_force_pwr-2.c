...

{
  ...
  iVar1 = *(int *)(pi + 0xe4);
  *(undefined *)(iVar1 + 0x444) = (char)indx;
  *(undefined *)(iVar1 + 0x445) = (char)indx;
  local_40 = indx + 0x240;
  local_4c = &local_30;
  local_44 = 7;
  local_3c = 0x20;
  local_48 = 1;
  FUN_00031ec8(pi,&local_4c);
  local_40 = indx + 0xc0;
  local_4c = &local_2c;
  local_3c = 0x20;
  FUN_00031ec8(pi,&local_4c);
  ...
  FUN_0002fde0(pi,&local_38);
  FUN_0002f99a(pi,local_2c >> 0x15 & 0xff);
  FUN_00032568(pi,(ushort)(local_30 >> 9) & 0xff);
