...

{
  ...
  do {
    ...
    puVar9 = *(ushort **)(*DAT_00004370 + (uint)((ushort *)p)[0xb] * 4);
    ...
    iVar1 = FUN_00004190(*(int *)(sdio_hw + 0xc),(ushort *)p);
    if (iVar1 == 0) {
      if (puVar5 == (undefined2 *)0x0) {
        iVar7 = FUN_00004204(sdio_hw,uVar10);
        if (iVar7 == 0) {
          FUN_0000638c(*(ushort ***)(sdio_hw + 4),(ushort *)p,0,uVar3);
          iVar1 = 1;
          goto LAB_0000431e;
        }
        puVar6 = (undefined2 *)FUN_00006404(*(int **)(sdio_hw + 4),p);
        puVar8 = puVar6;
      }
      else {
        puVar6 = (undefined2 *)FUN_00006404(*(int **)(sdio_hw + 4),p);
