...

{
  ...
  if (*(byte *)(sdio + 0x178) == 0) {
    ...
    if (uVar3 < uVar6 + 0xc) {
      uVar1 = p[6];
      puVar7 = (ushort *)FUN_00006348(ppuVar8,*(int *)(sdio + 0x1e4) + (uint)uVar1 + uVar6);
      if (puVar7 == (ushort *)0x0) goto LAB_000035c2;
      iVar4 = uVar6 + *(int *)(sdio + 0x1e4);
      puVar2 = (undefined4 *)(*(int *)(puVar7 + 4) + iVar4);
      *(undefined4 **)(puVar7 + 4) = puVar2;
      puVar7[6] = puVar7[6] - (short)iVar4;
      FUN_00002390(puVar2,*(undefined4 **)(p + 4),(uint)uVar1);
      puVar5 = *(ushort **)(*DAT_00003698 + (uint)p[10] * 4);
      if (puVar5 != (ushort *)0x0) {
        puVar5 = (ushort *)(uint)*puVar5;
      }
      puVar7[10] = (ushort)puVar5;
      FUN_0000638c(ppuVar8,p,0,puVar5);
    }
    if (uVar6 != 0) {
      iVar4 = *(int *)(puVar7 + 4);
    ...
    *(undefined4 **)(puVar7 + 4) = puVar2;
    iVar4 = FUN_00004744(ppuVar8,(int)puVar7);
    local_2a[0] = (ushort)iVar4;
    FUN_00002390(puVar2,(undefined4 *)local_2a,2);
    local_2a[0] = ~local_2a[0];
    FUN_00002390((undefined4 *)((int)puVar2 + 2),(undefined4 *)local_2a,2);
    uVar3 = (chan & 0xf) << 8 | (uint)*(byte *)(sdio + 0x108) | (uVar6 + 0xc) * 0x1000000;
    local_34 = uVar3;
    FUN_00002390(puVar2 + 1,&local_34,8);
    puVar7 = (ushort *)FUN_000033ac(sdio,puVar7,chan,uVar3);
...
LAB_000035c2:
    FUN_0000638c(ppuVar8,p,1,uVar3);
  }
  return puVar7;
}
