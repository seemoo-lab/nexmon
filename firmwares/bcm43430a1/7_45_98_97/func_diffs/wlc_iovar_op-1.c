...
LAB_000093f8:
  if ((int)(uint)*(byte *)(*wlc + 0xb8) <= iVar7) {
    ...
    if ((int)(uint)*(byte *)(*wlc + 0xb8) <= iVar7) goto LAB_00009454;
  }
  ...
  iVar8 = func_0x00803c8c(DAT_00009590,varname,7);
  if (iVar8 == 0) {
    if ((int)p_len < 4) {
      local_30 = -0xe;
      goto LAB_00009578;
    ...
    iVar8 = FUN_0001d1f0((int)wlc,local_2c[0],&local_30);
    if ((local_30 == -0x1e) && ((int)(uVar4 << 0x1f) < 0)) {
      ...
      if (iVar8 == 0) {
        ...
        local_30 = FUN_0001d5a0((int *)wlc,iVar8);
        if (local_30 != 0) {
          func_0x00847abc(wlc,iVar8);
        }
      }
    }
    if (local_30 != 0) goto LAB_00009578;
    varname = varname + 7;
    params = params + 1;
    p_len = p_len - 4;
    if ((int)(uVar4 << 0x1f) < 0) {
