...
// Hook call to hnd_tcam_load_default in c_main
__attribute__((at(0x183552, "", CHIP_VER_BCM4373a0, FW_VER_13_10_246_356_39f8a82_CY)))
BLPatch(hnd_tcam_load_default, hnd_tcam_load_default_hook);
