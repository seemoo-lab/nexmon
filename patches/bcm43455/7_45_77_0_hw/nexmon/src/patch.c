...
__attribute__((at(0x2087D8, "", CHIP_VER_BCM43455, FW_VER_7_45_77_0)))
BLPatch(wlc_ucode_write_compressed, wlc_ucode_write_compressed);

// reduce the amount of ucode memory freed to become part of the heap
__attribute__((at(0x19A3C8, "", CHIP_VER_BCM43455, FW_VER_7_45_77_0)))
...
__attribute__((at(0x21A3B4, "", CHIP_VER_BCM43455, FW_VER_7_45_77_0)))
