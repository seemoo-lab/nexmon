...
char date[] = DATE;
__attribute__((at(DATE_PTR, "", CHIP_VER_ALL, FW_VER_ALL)))
GenericPatch4(date_patch, date);

char time[] = TIME;
__attribute__((at(TIME_PTR, "", CHIP_VER_ALL, FW_VER_ALL)))
GenericPatch4(time_patch, time);

char version[] = "17.10.121.41 (r796515 nexmon.org: " GIT_VERSION "-" BUILD_NUMBER ")";
...
__attribute__((at(VERSION_PTR_4, "", CHIP_VER_ALL, FW_VER_ALL)))
