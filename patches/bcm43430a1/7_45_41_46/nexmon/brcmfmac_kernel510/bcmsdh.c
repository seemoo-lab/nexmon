...
static const struct sdio_device_id brcmf_sdmmc_ids[] = {
	...
	BRCMF_SDIO_DEVICE(SDIO_DEVICE_ID_BROADCOM_CYPRESS_4373),	/*SDIO_DEVICE_ID_CYPRESS_4373),*/
	BRCMF_SDIO_DEVICE(SDIO_DEVICE_ID_BROADCOM_CYPRESS_43012),	/*SDIO_DEVICE_ID_CYPRESS_43012),*/
	{ /* end: all zeroes */ }
};
