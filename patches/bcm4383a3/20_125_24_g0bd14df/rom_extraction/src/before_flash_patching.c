...
// Hook call to hnd_tcam_load_default in init_patch
__attribute__((at(0x7C13E6, "", CHIP_VER_BCM4383a3, FW_VER_20_125_24_g0bd14df)))
BLPatch(hnd_tcam_load_default_hook, hnd_tcam_load_default_hook);
