...
BEGIN {
	...
	fp_config_base_ptr_1_2 = strtonum(fp_config_base_ptr_1_2);
...
END {
	...
	printf "\t$(Q)printf %08x | xxd -r -p | dd of=$@ bs=1 conv=notrunc seek=$$((0x%08x - 0x%08x))\n", htonl(fp_config_base + 8), fp_config_base_ptr_1_2, ramstart;
	printf "\t$(Q)printf \"  PATCH fp_config_base_1_2 @ 0x%08x\\n\"\n", fp_config_base_ptr_1_2;
