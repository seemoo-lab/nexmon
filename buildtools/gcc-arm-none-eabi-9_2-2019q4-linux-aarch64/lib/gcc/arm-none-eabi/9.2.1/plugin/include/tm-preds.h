/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/dgboter/bbs/moonshot-dsg-07--aarch64/buildbot/aarch64-none-linux-gnu--arm-none-eabi/build/src/gcc/gcc/config/arm/arm.md'.  */
