...
%token ASM_ARCH ASM_SUBARCH ASM_START ASM_ASSERT SPR GPR OFFR LR COMMA SEMICOLON BRACK_OPEN BRACK_CLOSE PAREN_OPEN PAREN_CLOSE HEXNUM DECNUM ARCH_NEWWORLD ARCH_OLDWORLD LABEL IDENT LABELREF BRACE_OPEN BRACE_CLOSE
...
%token OP_MATH1 OP_MATH2 OP_MATH3 OP_MATH4 OP_MATH5 OP_MATH6 OP_MATH7 OP_MATH8 OP_MATH9 OP_MATHA OP_MATHB OP_MATHC OP_MATHD OP_MUL OP_ADD OP_ADDSC OP_ADDC OP_ADDSCC OP_XADD OP_XADDSC OP_XADDC OP_XADDSCC OP_SUB OP_SUBSC OP_SUBC OP_SUBSCC OP_XSUB OP_XSUBSC OP_XSUBC OP_XSUBSCC OP_SRA OP_OR OP_AND OP_XOR OP_SR OP_SRX OP_SRXH OP_SL OP_RL OP_RR OP_NAND OP_ORX OP_ORXH OP_MOV OP_JMP OP_JAND OP_JNAND OP_JS OP_JNS OP_JE OP_JNE OP_JLS OP_JGES OP_JGS OP_JLES OP_JL OP_JGE OP_JG OP_JLE OP_JZX OP_JZXH OP_JNZX OP_JNZXH OP_JEXT OP_JNEXT OP_JDN OP_JDPZ OP_JDP OP_JDNZ OP_JBOH OP_JNBOH OP_JBOH2 OP_JNBOH2 OP_JBOH3 OP_JNBOH3 OP_JBOH4 OP_JNBOH4 OP_XJE OP_XJNE OP_XJLS OP_XJGES OP_XJGS OP_XJLES OP_XJDN OP_XJDPZ OP_XJDP OP_XJDNZ OP_XJL OP_XJGE OP_XJG OP_XJLE OP_JMAH OP_JNMAH OP_JMAH2 OP_JNMAH2 OP_JMAH3 OP_JNMAH3 OP_JMAH4 OP_JNMAH4 OP_JMAH5 OP_JNMAH5 OP_JMAH6 OP_JNMAH6 OP_CALL OP_CALLS OP_CALLS2 OP_RET OP_RETS OP_RETS2 OP_RETS3 OP_TKIPH OP_TKIPHS OP_TKIPL OP_TKIPLS OP_NAP OP_NAP2 OP_NAPV OP_NAPV2 RAW_CODE
...
line	: line_terminator {
	...
	| line BRACE_OPEN statement BRACE_CLOSE line_terminator {
		struct statement *s = $3;
		if (s) {
			...
			if (s->type != STMT_INSN)
				yyerror("Cannot encode {} for non instruction statements");
			s->u.insn->weird = 1;
		}
	  }
...
asmdir		: ASM_ARCH hexnum_decnum {
		...
		| ASM_SUBARCH hexnum_decnum {
			struct asmdir *ad = xmalloc(sizeof(struct asmdir));
			ad->type = ADIR_SUBARCH;
			ad->u.arch = (unsigned int)(unsigned long)$2;
			$$ = ad;
		  }
...
/* math */
insn_math1	: OP_MATH1 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH1;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math2	: OP_MATH2 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH2;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math3	: OP_MATH3 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH3;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math4	: OP_MATH4 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH4;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math5	: OP_MATH5 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH5;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math6	: OP_MATH6 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH6;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math7	: OP_MATH7 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH7;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math8	: OP_MATH8 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH8;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_math9	: OP_MATH9 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATH9;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_mathA	: OP_MATHA operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATHA;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_mathB	: OP_MATHB operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATHB;
			insn->operands = $2;
			$$ = insn;
...
insn_mathC	: OP_MATHC operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATHC;
			insn->operands = $2;
			$$ = insn;
		...
		;
insn_mathD	: OP_MATHD operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_MATHD;
			insn->operands = $2;
			$$ = insn;
...
insn_jboh3	: OP_JBOH3 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JBOH3;
			insn->operands = $2;
			$$ = insn;
...
insn_jnboh3	: OP_JNBOH3 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNBOH3;
			insn->operands = $2;
			$$ = insn;
...
insn_jboh4	: OP_JBOH4 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JBOH4;
			insn->operands = $2;
			$$ = insn;
...
insn_jnboh4	: OP_JNBOH4 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNBOH4;
			insn->operands = $2;
			$$ = insn;
...
insn_jmah2	: OP_JMAH2 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JMAH2;
			insn->operands = $2;
			$$ = insn;
...
insn_jnmah2	: OP_JNMAH2 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNMAH2;
			insn->operands = $2;
			$$ = insn;
...
insn_jmah3	: OP_JMAH3 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JMAH3;
			insn->operands = $2;
			$$ = insn;
...
insn_jnmah3	: OP_JNMAH3 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNMAH3;
			insn->operands = $2;
			$$ = insn;
...
insn_jmah4	: OP_JMAH4 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JMAH4;
			insn->operands = $2;
			$$ = insn;
...
insn_jnmah4	: OP_JNMAH4 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNMAH4;
			insn->operands = $2;
			$$ = insn;
...
insn_jmah5	: OP_JMAH5 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JMAH5;
			insn->operands = $2;
			$$ = insn;
...
insn_jnmah5	: OP_JNMAH5 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNMAH5;
			insn->operands = $2;
			$$ = insn;
...
insn_jmah6	: OP_JMAH6 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JMAH6;
			insn->operands = $2;
			$$ = insn;
...
insn_jnmah6	: OP_JNMAH6 operlist_3 {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			insn->op = OP_JNMAH6;
			insn->operands = $2;
			$$ = insn;
...
insn_calls2	:  OP_CALLS2 labelref {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			struct operlist *ol = xmalloc(sizeof(struct operlist));
			struct operand *oper_r0 = xmalloc(sizeof(struct operand));
			struct registr *r0 = xmalloc(sizeof(struct registr));
...
insn_napv2	: OP_NAPV2 hexnum_decnum COMMA hexnum_decnum COMMA hexnum_decnum {
			struct instruction *insn = xmalloc(sizeof(struct instruction));
			struct operlist *ol = xmalloc(sizeof(struct operlist));
			struct operand *oper1 = xmalloc(sizeof(struct operand));
			struct operand *oper2 = xmalloc(sizeof(struct operand));
			struct operand *oper3 = xmalloc(sizeof(struct operand));
			oper1->type = OPER_RAW;
			oper1->u.raw = (unsigned long)$2;
			oper2->type = OPER_RAW;
			oper2->u.raw = (unsigned long)$4;
			oper3->type = OPER_RAW;
			oper3->u.raw = (unsigned long)$6;
			ol->oper[0] = oper1;
			ol->oper[1] = oper2;
			ol->oper[2] = oper3;
			insn->op = OP_NAPV2;
		...
		;
// insn_napv2	: OP_NAPV2 operlist_3 {
// 			struct instruction *insn = xmalloc(sizeof(struct instruction));
// 			insn->op = OP_XJLE;
// 			insn->operands = $2;
// 			$$ = insn;
