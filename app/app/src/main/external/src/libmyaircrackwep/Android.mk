...
LOCAL_SRC_FILES		:= \
	...
	$(AIRCRACK_NG_PATH)/src/uniqueiv.c \
	$(AIRCRACK_NG_PATH)/src/simd-intrinsics.c \
	$(AIRCRACK_NG_PATH)/src/cpuid.c \
	$(AIRCRACK_NG_PATH)/src/memory.c \
	$(AIRCRACK_NG_PATH)/src/wpapsk.c \
	$(AIRCRACK_NG_PATH)/src/linecount.cpp \
	$(AIRCRACK_NG_PATH)/src/aircrack-ptw-lib.c
...
LOCAL_CFLAGS		+= \
	...
	-mfloat-abi=softfp -mfpu=neon -march=armv7 -DSIMD_CORE

LOCAL_SHARED_LIBRARIES  := libandroidlogger
LOCAL_STATIC_LIBRARIES  := libssl libcrypto libosdep libsqlite
