...
#include "attacks/attacks_authflood.h"
#include "osdep.h"
#include "ghosting.h"
#include "fragmenting.h"
#include "attackauthflood.h"
...
int attack_auth_flood(JNIEnv* pEnv, jobject pThis, jmethodID pMid, jmethodID pMid_stats, char* interface_name, char* ap_mac, int intelligent, int myid) {
  ...
  cur_options = cur_attack->parse_options(ap_mac, intelligent);
